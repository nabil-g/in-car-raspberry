...
view model =
    ...
    , body = [ Element.layoutWith { options = [ focusStyle <| FocusStyle Nothing Nothing Nothing ] } [ Font.size 18, height fill, Background.color <| rgb255 112 135 240, Font.color whiteColor ] <| viewBody model ]
    }
